...
function graphy_header_meta() {
	...
	<div class="entry-meta">
		<span class="posted-on"><?php _e( '', 'graphy' ); ?>
		...
		<span class="comments-link">&middot; <?php comments_popup_link( __( '评论(0)', 'graphy' ), __( '评论(1)', 'graphy' ), __( '评论(%)', 'graphy' ) ); ?></span>
		<?php endif; ?>
		<span class="posted-on">阅读(<?php post_print_read_count(); ?>)
